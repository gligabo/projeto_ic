...
class Algorithms:
    ...
    @staticmethod
    def ista_exato_relaxado( f, x0, grad_f, prox, gamma, eta, Q, max_iter = 1000, tol = 1.0e-1, wavelet = 'haar' ):
        x = x0.copy()
        iterations = 0
        iters = [ x.copy() ]
        dif = float( 'inf' )
    ...
    @staticmethod
    def fista_exato_relaxado( f, x0, Q, grad_f, prox, gamma, eta, max_iter = 1000, tol = 1.0e-1, wavelet = 'haar'  ):
        y0 = x0.copy()
        x = x0.copy()
        iterations = 0
        t0 = 1
