...
Um método amplamente conhecido para resolver esses problemas é o Iterative Shrinkage-Thresholding Algorithm (ISTA), que é de primeira ordem. 
Entretanto, o ISTA apresenta convergência lenta, tornando-se inadequado para problemas de grande escala. 
...
A widely known method for solving these problems is the Iterative Shrinkage-Thresholding Algorithm (ISTA), which is first-order.
However, ISTA exhibits slow convergence, making it unsuitable for large-scale problems.
