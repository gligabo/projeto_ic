...
O objetivo do seguinte projeto de iniciação científica é estudar o uso de busca direcional exata no passo de máxima descida do método de gradiente-proximal acelerado conhecido como FISTA~\cite{bet09,bet09b} aplicado ao problema~\eqref{eq:reg_LS}. Se considerarmos o problema
$$
    \min_{\bm x \in \mathbb R^n} \quad F( \bm x ) = f( \bm x ) + g( \bm x ),
$$
